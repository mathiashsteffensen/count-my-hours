...
export default function WorkListing({workHours, refresh}) 
{
    ...
    return (
        <div className="py-2 lg:p-y0 flex justify-between items-center w-11/12 bg-primary mb-2 px-4 rounded-lg shadow-lg">
            <p className="m-0 lg:w-3/5">{startTime} - {endTime}</p>
            <p className="m-0 lg:w-3/5">{workHours.startTime.slice(8, 10)}/{workHours.startTime.slice(5, 7)}</p>
